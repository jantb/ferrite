...
`FERRITE_SMALL_M_QMV4` enables Ferrite's BN16/4-simdgroup qmv4 path for small-M quantized linears; set it to `0` to force stock MLX `quantized_matmul`. `FERRITE_SMALL_M_QMV4_STRICT=1` turns fallback shader failures into request errors.
